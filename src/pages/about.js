    ...
    <div className="min-h-screen bg-[#f7f7f5] text-gray-800 px-6 py-16 font-sans">
      ...
      >
        ...
        <p className="mb-4">
          ...
          <p className="mb-4 ">After graduating high school in 2021, I didn’t make art for three years. I was busy as a computer science student. In Summer 2024, I bought an iPad and Procreate using internship money, and I was finally able to pursue my passion again. Since December 2024, I&rsquo;ve been learning how to translate my traditional style into digital work. It’s a weird mix of my old realism habits, surreal ideas I wish I could implement, and a complete MIXED BAG of concepts (I draw a lot of animals, or day to day human things, but sometimes I just want to illustrate someone gouging their own eyes out... you know, balance).</p>
